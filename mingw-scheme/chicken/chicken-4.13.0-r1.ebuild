# Copyright 1999-2020 Gentoo Authorsp
...
#	sed -e "s/direct.h/sys\/stat.h/" -i posixwin.c || die
...
src_compile() {
	emake -j1 PLATFORM=cross-linux-mingw PREFIX=/usr/x86_64-w64-mingw32/usr C_COMPILER_OPTIMIZATION_OPTIONS="${CFLAGS}" \
...
src_install() {
	...
	emake -j1 PLATFORM=cross-linux-mingw PREFIX=/usr/x86_64-w64-mingw32/usr DESTDIR="${D}" HOSTSYSTEM=x86_64-w64-mingw32 \
